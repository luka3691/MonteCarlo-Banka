...
public class GeneratorPodlaRoku {
    ...
    public GeneratorPodlaRoku(int zaciatocnyRok) {
        ...
        this.pravdepodobnosti = Arrays.asList( new DiskretneRovnomerne(1, 4), new SpojiteRovnomerne(0.3, 5.0), new SpojiteEmpiricke(hraniceEmpiricke, pravdepodobnostiEmpiricke), new Deterministicke(1.3), new SpojiteRovnomerne(0.9, 2.2));
